...
Dentro deste
contexto, definimos o \textbf{comprimento} da palavra-código \emph{w}
como \emph{l}(\emph{w}), um \textbf{inteiro positivo} que representa o
tamanho da cadeia que compõe a palavra-código \emph{w}.  Tome como
exemplo o alfabeto de origem \emph{M} = \{a, b, c\} e o alfabeto
código \emph{W} = \{0, 1\} composto somente por valores binários,
poderíamos definir o código \emph{C} da seguinte forma:
