...
Tome como exemplo o alfabeto de origem
\emph{M} = \{a, b, c\} e o alfabeto código \emph{W} = \{0, 1\}
composto somente por valores binários, poderíamos definir o código
\emph{C} da seguinte forma:
